...
def tester(seed, config, target_file_name, sobol):
    ...
    try:        
        ...
        print(f'TESTER_EXP: {TESTER_EXP}, PARAM_MATCHING: {PARAM_MATCHING}, MINIMIZE_ERROR: {MINIMIZE_ERROR}')
        ...
        if not os.path.exists(config.CHANNEL_SIM_LIMITS_FILE):
            print(f'WARNING: ¡{config.CHANNEL_SIM_LIMITS_FILE} not found! Creating with channel_test_limits()...')
        ...
        print("----------Step 5: Initializing Ax and monitors----------")
        ...
        try:
            for trial in range(sobol + NUM_TRIALS_FB):
                ...
                print(f'Parámeters generated by Ax: {parameters}')
                ...
                print(f'Trial {trial_idx} saved in TXT: {txt_indi}')
                ...
                print(f'Converting Txt to JSON')
